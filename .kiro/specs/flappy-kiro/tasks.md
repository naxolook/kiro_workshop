...
- [x] 2. Implementar `ScoreManager` y su persistencia en `localStorage`
  - [x] 2.1 Implementar la clase `ScoreManager`
  ...
  - [x] 2.2 Escribir prueba de propiedad: round-trip de récord en localStorage
  ...
  - [x] 2.3 Escribir prueba de propiedad: reset preserva el récord
  ...
  - [x] 2.4 Escribir prueba de propiedad: formato del texto de puntaje
  ...
  - [x] 2.5 Escribir prueba de propiedad: incremento de puntaje al pasar un tubo
...
- [x] 3. Implementar `PhysicsEngine`
  - [x] 3.1 Implementar la clase `PhysicsEngine`
  ...
  - [x] 3.2 Escribir prueba de propiedad: el aleteo establece velocidad fija hacia arriba
  ...
  - [x] 3.3 Escribir prueba de propiedad: integración física correcta
  ...
  - [x] 3.4 Escribir prueba de propiedad: velocidad terminal máxima descendente
...
- [x] 4. Implementar `PipeManager`
  - [x] 4.1 Implementar la clase `PipeManager`
  ...
  - [x] 4.2 Escribir prueba de propiedad: velocidad de tubos proporcional al puntaje
  ...
  - [x] 4.3 Escribir prueba de propiedad: reciclaje de tubos fuera de pantalla
  ...
  - [x] 4.4 Escribir prueba de propiedad: invariantes del hueco de tubos
...
- [x] 5. Punto de control — Verificar módulos de lógica central
...
- [x] 7. Implementar `AudioManager`
  ...
  - [x] 7.1 Escribir pruebas de ejemplo para `AudioManager`
...
- [x] 8. Implementar `InputHandler`
  ...
  - [x] 8.1 Escribir pruebas de ejemplo para `InputHandler`
...
- [x] 9. Implementar `Renderer`
  ...
  - [x] 9.1 Escribir pruebas de ejemplo para `Renderer`
...
- [x] 10. Implementar `GameController` e integrar todos los módulos
  - [x] 10.1 Implementar la clase `GameController`
  ...
  - [x] 10.2 Implementar la detección de colisiones AABB en `GameController`
  ...
  - [x] 10.3 Escribir prueba de propiedad: detección de colisión AABB
  ...
  - [x] 10.4 Escribir prueba de propiedad: parámetros proporcionales al viewport tras resize
  ...
  - [x] 10.5 Implementar el balanceo idle de Ghosty en el bucle de renderizado
...
- [x] 11. Punto de control final — Verificar integración completa
